...
enum InAppPurchaseErrorStrings: String{
    ...
    case noPurchasesFound = "No purchases found. Are you sure you have purchases to restore?"
    case genericRestorePurchasesFailed = "Error restoring transactions. Please try again later."
}